...
# ============================================================================
# IMPROVED DATASET GENERATOR - 5000 diverse Indian student profiles
# ============================================================================
...
print("=" * 80)
print("GENERATING IMPROVED DATASET - 5000 Indian Student Profiles")
print("=" * 80)
...
print("\nGenerating 5000 student profiles...")
...
for student_id in range(num_students):
    ...
    if (student_id + 1) % 500 == 0:
        print(f"  Generated {student_id + 1}/5000 profiles...")
...
# Save to CSV
output_file = 'indian_students_career_dataset_synthetic_5000.csv'
